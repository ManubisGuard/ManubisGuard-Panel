...
main "$@"
 "$WORKDIR/env-restore.log"; then
    ENV_IMPORTED=true
    log "Legacy runtime settings prepared. Current ManubisGuard DB identity remains protected."
  else
    log "Legacy .env not present. Current ManubisGuard .env will be preserved."
  fi
}
