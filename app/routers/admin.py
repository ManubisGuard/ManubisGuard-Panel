...
async def admin_token(
    ...
    return Token(access_token=await create_admin_token(db_admin.id, form_data.username, db=db))
...
async def admin_mini_app_token(
    ...
    asyncio.create_task(notification.admin_login(db_admin.username, "", client_ip, True))
    return Token(access_token=await create_admin_token(db_admin.id, db_admin.username, db=db))
